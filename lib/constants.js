...
aggregates = [                                      //order is important
      ...
      {id:'s_'+"Arabic"+'_propernouns', name:"مہم اسماء مرفوعة", lang:"Arabic"},
      {id:'s_'+"Arabic"+'_nouns', name:"مہم اسماء", lang:"Arabic"},
      {id:'s_'+"Arabic"+'_adjectives', name:"مہم صفة", lang:"Arabic"},
      {id:'s_'+"Arabic"+'_verbs', name:"مہم افعال", lang:"Arabic"},
      ...
      {id:'s_EnglishCorpus_phrases', name:"Significant English Corpus Phrases", lang:"EnglishCorpus"},
      {id:'s_EnglishCorpus', name:"Significant Words from English Corpus", lang:"Corpus (English)"},
